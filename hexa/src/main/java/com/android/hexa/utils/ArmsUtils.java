 ...
 */
package com.android.hexa.utils;
...
import com.android.hexa.base.App;
import com.android.hexa.di.component.AppComponent;
import com.android.hexa.integration.AppManager;
...
public class ArmsUtils {
    ...
    public static String getString(Context context, String strName) {
        return getString(context, getResources(context).getIdentifier(strName, "string", context
                .getPackageName()));
    }
     ...
     * @return
     */
    public static <T extends View> T findViewByName(Context context, Activity activity, String
            viewName) {
        int id = getResources(context).getIdentifier(viewName, "id", context.getPackageName());
     ...
     * Arms 则会使用 Toast 替代 Snackbar 显示信息, 如果框架使用者依赖了 arms-autolayout 库就不用依赖 com.android
     * .support:design 了
    ...
    public static AppComponent obtainAppComponentFromContext(Context context) {
        ...
        Preconditions.checkState(context.getApplicationContext() instanceof App, "%s must be " +
                "implements %s", context.getApplicationContext().getClass().getName(), App.class
                .getName());
