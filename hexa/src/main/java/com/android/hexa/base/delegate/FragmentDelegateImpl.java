...
public class FragmentDelegateImpl implements FragmentDelegate {
    ...
    public FragmentDelegateImpl(@NonNull android.support.v4.app.FragmentManager fragmentManager,
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        iFragment.setupFragmentComponent(ArmsUtils.obtainAppComponentFromContext(mFragment
                .getActivity()));
    }
