...
public class HexaUtil {
    ...
    public static AppComponent obtainAppComponentFromContext(Context context) {
        ...
        Preconditions.checkState(context.getApplicationContext() instanceof AppInject, "%s must be " +
                "implements %s", context.getApplicationContext().getClass().getName(), AppInject.class
                .getName());
        return ((AppInject) context.getApplicationContext()).getAppComponent();
    }
