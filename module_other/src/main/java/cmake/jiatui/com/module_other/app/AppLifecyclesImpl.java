package cmake.jiatui.com.module_other.app;
...
import cmake.jiatui.com.module_other.BuildConfig;

/**
 * ================================================
 * 展示 {@link AppLifecycles} 的用法
 * <p>
 * Created by ArmsComponentTemplate on 12/04/2018 19:05
        ...
        if (BuildConfig.IS_BUILD_MODULE) {
            ...
            ArmsUtils.obtainAppComponentFromContext(application).extras()
                    .put(IntelligentCache.getKeyOfKeep(RefWatcher.class.getName())
                            , BuildConfig.USE_CANARY ? LeakCanary.install(application) :
                                    RefWatcher.DISABLED);
        }
    }
